/**
 * Official WalletConnect icon
 * From: https://github.com/WalletConnect/walletconnect-assets
 */
...
export const WalletConnectIcon = ({ size = 24, color = "#fff" }: WalletConnectIconProps) => (
